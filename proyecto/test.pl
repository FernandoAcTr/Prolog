...
test :-
    new(Dialog, dialog('Test')),
		...
		[
			...
			new(B, menu('2. Por las mananas me siento mejor que por las tardes')),
			...
			new(F, menu('6. Todavia me siento atraido por el sexo opuesto')),
			new(G, menu('7. Creo que estoy adelgazando')),
			new(H, menu('8. Estoy estrenido')),
			new(I, menu('9. Tengo palpitaciones')),
			new(J, menu('10. Me canso por cualquier cosa')),
			new(K, menu('11. Mi cabeza esta tan despejada como antes')),
			...
			new(N, menu('14. Tengo esperanza y confio en el futuro')),
			new(O, menu('15. Me siento mas irritable que habitualmente')),
			new(P, menu('16. Encuentro facil tomar decisiones')),
			new(Q, menu('17. Me creo util y necesario para la gente')),
			new(R, menu('18. Encuentro agradable vivir, mi vida es plena')),
			new(S, menu('19. Creo que seria mejor para los demas si me muriera')),
			new(T, menu('20. Me gustan las mismas cosas que solian agradarme'))
		]),
