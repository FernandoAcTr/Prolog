...
hipotesis('Depresion con sintomas psicoticos'):- depresion_con_sintomas_psicoticos, !.
hipotesis('Depresion perinatal'):- depresion_perinatal, !.
hipotesis('Depresion postparto') :- depresion_posparto, !.
hipotesis('Transtorno bipolar') :- transtorno_bipolar, !.
hipotesis('Transtorno distimico') :- transtorno_distimico, !.
...
sintomas_fisicos:- pregunta('¿Tienes dificultad para depertar temprano por la manana?').
...
enfermedad_organica:- pregunta('¿Tienes una enfermedad organica que te provoque cansancio?').
...
sintomas_mentales:- pregunta('¿Te sientes inutil o impotente?').
...
alteraciones_gastrointestinales:- pregunta('¿Enfermaste recientemente de extrenimiento?').
alteraciones_gastrointestinales:- pregunta('¿Enfermaste recientemente de diarrea?').
alteraciones_gastrointestinales:- pregunta('¿Enfermaste recientemente de ulcera gastrica?').

alteraciones_genitourinarias:- pregunta('¿Presentas molestias al orinar?'). 
alteraciones_genitourinarias:- pregunta('¿Tienes ausencia de menstruacion?'). 
...
alteraciones_neurologicas:- pregunta('¿Usualmene presentas cefalea?'). 
alteraciones_neurologicas:- pregunta('¿Usualmene presentas vertigo o temblores?'). 

alteraciones_respiratorias:- pregunta('¿Has sentido sensacion de ahogo sin razon aparente?').
alteraciones_respiratorias:- pregunta('¿Has sentido dificultad respiratoria sin razon aparente?').
...
ideas_delirantes:- pregunta('¿Has pensamientos de catatrofes mundiales?'). 

% ----------------- Transtorno bipolar -----------
transtorno_bipolar:- 
      posible_depresion,
      pregunta('¿Sufres alteraciones repentinas en tu estado del animo?'), 
      pregunta('¿Te exhaltas facilmente').

% ----------------- Transtorno distimico -----------
transtorno_distimico:- 
      posible_depresion,
      pregunta('¿Tienes mas de 40 anos?'),
